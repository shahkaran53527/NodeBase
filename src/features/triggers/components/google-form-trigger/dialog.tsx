        ...
        <div className="space-y-4">
          ...
          <div className="rounded-lg bg-muted p-4 space-y-2">
            ...
            <ol className="text-sm text-muted-foreground space-y-1 list-decimal list-inside">
              ...
              <li>
                {
                  "Click the three dots on the top right corner -> Script editor"
                }
              </li>
              <li>Copy and paste the script below</li>
              <li>Replace WEB_HOOK_URL with your webhook URL above</li>
          ...
          <div className="rounded-lg bg-muted p-4 space-y-2">
            ...
            <ul className="text-sm text-muted-foreground space-y-1">
              <li className="bg-background px-1 py-0.5 rounded">
                <code>{"{{googleForm.respondentEmail}}"}</code>-
                Respondent&apos;s email
              </li>
              <li className="bg-background px-1 py-0.5 rounded">
              ...
              <li className="bg-background px-1 py-0.5 rounded">
                <code>{"{{json googleForm.responses}}"}</code>- All responses as
                JSON
              </li>
            </ul>
          </div>
